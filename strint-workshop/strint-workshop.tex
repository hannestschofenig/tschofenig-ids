...
%The toolbox is full of great security technologies. 

%Securing the Internet has been an on-going activity since its beginning and the ever changing nature of the Internet (in size, and use) but also the changes in the treat landscape ensure that security will keep various communities busy. 

%instead of increasing their trust in the digital market place.  
...
% Researchers and the press have speculated about the NSA influence in the standardization processes.


%In addition to potential advances in cryptanalysis, rumors about back-doors in specific elliptic curves, and random number generators have created some uncertainty about what algorithms are 'safe' to use. 
